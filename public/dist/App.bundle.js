...
var autoComplete = function autoComplete(addressInput, latInput, lngInput) {
...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    ...
    var heartClassList = _this.heart.classList;
    var isHearted = heartClassList.toggle('heart__button--hearted');
...
var _sweetalert = __webpack_require__(33);
...
var loadPlaces = function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    if (!places.length) {
      _sweetalert2.default.fire({
        ...
        return (0, _bling.$)('[name="geolocate"]').value = '';
      }).catch(function (err) {
        return console.error(err);
      });
      return;
...
(function (global, factory) {
  ( false ? 'undefined' : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : (global = global || self, global.Sweetalert2 = factory());
})(undefined, function () {
  'use strict';
